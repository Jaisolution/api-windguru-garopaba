...
def extrair_temperatura_agua(html):
    ...
    try:
        ...
        # Procura especificamente o bloco do spot de Garopaba.
        # Depois da latitude/longitude procura o par de horarios
        # e a temperatura mostrada no cabecalho do Windguru.
        ...
        print(
            "Temperatura da agua nao encontrada"
        )
...
def montar_dias(modelos):
    ...
    for i, hora in enumerate(
        ...
        # ====================================================
        # ENCONTRAR MESMO HORARIO NO GFS
        # ====================================================
...
def garopaba():
    ...
    try:
        ...
        temperatura_agua = extrair_temperatura_agua(
            html
        )
